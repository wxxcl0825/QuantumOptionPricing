...
"")
        ...
        self.taskwidget = QtWidgets.QWidget(self.task)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.taskwidget.setFont(font)
        self.taskwidget.setObjectName("taskwidget")
        self.verticalLayout_3.addWidget(self.taskwidget)
...
"font: 10pt \"Hitmo2.0\";")
        ...
        self.classicwidget = QtWidgets.QWidget(self.classic)
        self.classicwidget.setObjectName("classicwidget")
        self.verticalLayout_5.addWidget(self.classicwidget)
...
"font: 10pt \"Hitmo2.0\";")
        ...
        self.quantumwidget = QtWidgets.QWidget(self.quantum)
        self.quantumwidget.setObjectName("quantumwidget")
        self.verticalLayout_6.addWidget(self.quantumwidget)
